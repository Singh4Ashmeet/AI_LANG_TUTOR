    ...
    <>
      <div className={styles.topNav}>
        ...
        <div className={styles.right}>
          <button type="button" className={styles.statPill} onClick={() => setShopOpen(true)}>
            <span className={styles.statIcon}>💎</span>
            <div>
          ...
          <button className={styles.bell} onClick={() => setOpen((prev) => !prev)} type="button">
          ...
          <div className={styles.panel}>
            ...
            <div className={styles.panelList}>
              ...
              {notifications.map((item) => (
                <div key={item._id} className={`${styles.panelItem} ${item.read ? styles.read : ""}`}>
